...
$x = $main->getAllowedIps($router->subdomain[0], getUserIpAddr());
if(!$x){
...
$menuItems = $menu->getMenuItems($_SESSION['user']['restaurantId']);
?>
<!doctype html>
<html lang="en">
...
<body>
							...
							<ul class="list">
								...
								<li>
									...
									<div style="margin-left: 20px; float: right;">
										...
										<span class="label" style="font-size:16px;font-weight: 600;color: black;" id="<?php echo $itemvalue['id']; ?>-item-count"><?php echo (!empty($cartItems[$itemvalue['id']]))? $cartItems[$itemvalue['id']]['itemCount'] : 0; ?></span>
	...
	<div class="center" style="margin:0 auto;text-align: center;align-content: center;">
		<a type="submit" href="/show-orders" class="btn btn-lg fixedBtn" style="background-color:#ef4565;color:white;font-weight:700;position: fixed;bottom: 0px;
		right: 0px; left: 0; ">
			Place Order
		</a>
	</div>
